<template>
  <PreviewImage
    ...
    :typeImage="IMAGE_TYPE.FLOOR_PLAN"
    :typeDelete="IMAGE_TYPE_DELETE.FLOOR_PLAN"
    @updateList="initData"
  ></PreviewImage>
</template>
...
import { getDetailSpaceImagesFloorPlan } from "@/api";
  ...
  setup() {
    ...
    const initData = async () => {
      try {
        ...
        const response = await getDetailSpaceImagesFloorPlan(id);
        let convertArray = [];
